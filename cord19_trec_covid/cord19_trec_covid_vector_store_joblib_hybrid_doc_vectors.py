...
tfidf_matrix = load("../joblibs/cord19_trec_covid/cord19_trec_covid_data_tfidf_matrix.joblib")

# Load dense Word2Vec document embeddings
w2v_embeddings = load("../joblibs/cord19_trec_covid/cord19_trec_covid_data_doc_embeddings.joblib")
...
dump(hybrid_doc_vectors, "../joblibs/cord19_trec_covid/cord19_trec_covid_data_hybrid_doc_vectors.joblib")
